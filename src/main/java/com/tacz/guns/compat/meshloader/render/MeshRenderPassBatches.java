 ...
 *
 * <p>与姊妹项目 refab 26.1.2 `9412e08`（`cn.sh1rocu.tacz.compat.meshloader.render.MeshRenderPassBatches`）
 * 同源；无 Minecraft / GL 依赖，便于用独立回归（`./gradlew meshRenderPassTest`）校验分批策略。</p>
 */
